  ...
  <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
    ...
    <div className='pt-20 pb-48 px-4'>
        <div className='container mx-auto'>
            <h1 className='text-black text-5xl text-center'> Here are our heroes</h1>
            <p className='text-black pt-10 text-center'>   According to the National Oceanic and Atmospheric <br /> Administration,Ted, Scambos, NSIDClead scentist, puts the <br/>potentially record
            maximum.</p>
